...
public record ArmorSet
{
    ...
    [JsonPropertyName("armorRating")] public int ArmorRating { get; init; }
    [JsonPropertyName("speed")] public int Speed { get; init; }
    [JsonPropertyName("stamina")] public int Stamina { get; init; }
    [JsonPropertyName("passive")] public string Passive { get; init; } = "";
